...
const Signup = () => {
    ...
    const[phone, setPhone]=useState('')
      ...
      const submitHandler=async(e)=>{
          e.preventDefault()
          try {
            const response=await axios.post('http://localhost:3205/api/users/signup',{
  ...
  return (
    <div style={styles.container}>
      <div style={styles.signupBox}>
        ...
        <input type="text" placeholder="Phone Number" onChange={(e)=>setPhone(e.target.value)} style={styles.input} />
