        ...
        <div className="container mx-auto flex flex-col md:flex-row gap-8 p-4">
          <div className="w-full max-w-5xl mx-auto flex flex-col md:flex-row gap-8 p-4 bg-white rounded-lg shadow-lg">
            ...
            <div className="w-full md:w-1/3">
              <div className="p-6 bg-white rounded-lg shadow-xl border border-gray-300">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full px-4 py-3 bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white rounded-lg hover:bg-green-700 transition duration-300"
                  >
                    Confirm Booking
                  </button>
                </form>
